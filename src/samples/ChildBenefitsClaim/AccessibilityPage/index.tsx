  ...
  return (
    <>
      ...
      <div className='govuk-width-container'>
        <MainWrapper>
          <h1 className='govuk-heading-l'>{t('ACCESSIBLITY_STATEMENT_FOR_CHB_SERVICE')}</h1>
          ...
          <p className='govuk-body'>
            <a className='govuk-link' href='https://mcmw.abilitynet.org.uk/'>
          ...
          <p className='govuk-body'>
            {t('YOU_CAN')}{' '}
            <a className='govuk-link' href='https://www.gov.uk/get-help-hmrc-extra-support'>
          ...
          <p className='govuk-body'>
            ...
            <a className='govuk-link' href='https://www.equalityadvisoryservice.com/'>
              {t('CONTACT_THE_EASS')} {t('OPENS_IN_NEW_TAB')}
            </a>
            {t('OR_THE')}
            <a className='govuk-link' href='https://www.equalityni.org/Home'>
