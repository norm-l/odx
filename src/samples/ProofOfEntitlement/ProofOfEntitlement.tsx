...
export default function ProofOfEntitlement() {
    ...
    document.addEventListener('SdkConstellationReady', () => {
      ...
      PCore.onPCoreReady(() => {
        ...
        PCore.getDataPageUtils()
          ...
          .then(result => {
            setPrintView(result.DocumentContentHTML);
          })
          .catch(err => {
  ...
  const printPOE = e => {
    ...
    myWindow.document.write(printView);
    myWindow.print();
  };
          ...
          <MainWrapper>
            {entitlementData && (
              <>
                ...
                <Button variant='link' onClick={e => printPOE(e)}>
                  {t('PRINT_THIS_PAGE')}
                </Button>
                ...
                <dl className='govuk-summary-list'>
                  ...
                  <ReadOnlyDisplay
                    ...
                    value={`£${entitlementData.AwardValue?.toString()} ${t('PER_WEEK')}`}
                  />
                  <ReadOnlyDisplay
                    key='startdate'
