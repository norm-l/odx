...
export default function MainWrapper({
  ...
  pageNotWorkingURL = undefined
}) {
  const { hmrcURL } = useHMRCExternalLinks();
  const pageNotWorkingUpdatedUrl = pageNotWorkingURL || `${hmrcURL}contact/report-technical-problem?newTab=true&service=463&referrerUrl=${window.location}`;
