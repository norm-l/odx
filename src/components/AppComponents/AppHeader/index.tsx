...
export default function AppHeader(props) {
  ...
  return (
    <>
    <a href="#main-content" className="govuk-skip-link" data-module="govuk-skip-link">{t("SKIP_TO_MAIN")}</a>
    <header role="banner">
      <div className="govuk-header hmrc-header  hmrc-header--with-additional-navigation" data-module="govuk-header">
