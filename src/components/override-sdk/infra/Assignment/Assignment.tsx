...
import useTranslatedText from '../../../helpers/hooks/useTranslatedText';
...
export default function Assignment(props) {
  ...
  const assignmentHeading = useTranslatedText(thePConn, containerName, '', localeReference);
        ...
        <div id='Assignment'>
          ...
          <MainWrapper>
            ...
            {(!isOnlyFieldDetails.isOnlyField ||
              ...
              <h1 className='govuk-heading-l'>{assignmentHeading}</h1>
            )}
