  ...
  return (
    <>
      <TableContainer component={Paper} style={{ margin: '4px 0px' }} id='simple-table-manual'>
        ...
        {propsToUse.label && ( <caption className="govuk-table__caption govuk-table__caption--m">{propsToUse.label} {results()}</caption>
)}
          <thead className="govuk-table__head">
            <tr>
              {fieldDefs.map((field: any, index) => {
                return (
                  <th key={`head-${displayedColumns[index]}`} scope="col" className="govuk-table__header">
                    {readOnlyMode ? (
                      <div>
                        <TableSortLabel
                  ...
                  return (
                    ...
                    <tr key={index} className="govuk-table__row">
                      {displayedColumns.map(colKey => {
                        return (
                          <td key={colKey} className="govuk-table__cell govuk-table__cell--numeric">
